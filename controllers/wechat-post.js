...
var CheckUsers, access_token, checkMenus, checkToken, getToken, getUserInfo, getUsers, https, options_create_menu, options_custom, options_get_access_token, options_get_menu, options_send, options_user_info, options_users, post_data, querystring, sendMenus, url;
...
getUsers = function(Next_OpenID) {
  ...
  if (Next_OpenID === "start" || Next_OpenID) {
    request = https.get(options_users.host + access_token.access_token, function(res) {
      return res.on('data', function(chunk) {
        var obj;
        obj = JSON.parse(chunk);
        console.log(obj);
